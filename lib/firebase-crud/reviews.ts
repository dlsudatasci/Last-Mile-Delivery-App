            ...
            for (const [deviationId, answer] of Object.entries(review.answers)) {
                ...
                if (answer.questionnaire) {
                    ...
                    batch.set(deviationResponseRef, {
                        ...
                        rushHour: answer.questionnaire.rushHour ?? null,
                        chooseDuringNonRush: answer.questionnaire.chooseDuringNonRush ?? null,
                        wouldUseNonRushHour: answer.questionnaire.wouldUseNonRushHour ?? null,
                        blockageReason: answer.questionnaire.blockageReason ?? null,
                        blockageType: answer.questionnaire.blockageType ?? null,
                        personalStopReason: answer.questionnaire.personalStopReason ?? [],
                        personalStopType: answer.questionnaire.personalStopType ?? null,
                        ...
                        otherDeviateReason: answer.questionnaire.otherDeviateReason ?? null,
                        submittedAt: Date.now(),
                        createdAt: Date.now(),
                    });
                }
